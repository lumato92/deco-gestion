                ...
                {tipoNueva === 'otro' ? (
                  <div className="flex gap-2">
                    <input type="text" placeholder="Nombre del artículo..."
                      ...
                      className="flex-1 text-sm bg-surface border border-gray-200 rounded-lg px-3 py-1.5 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-purple-400" />
